...
enum Couleur
{
    /** La couleur bleu foncé à pour code couleur 1*/
    bleuFonce = 1,
    /** La couleur vert foncé à pour code couleur 2*/
    vertFonce = 2,
    /** La couleur bleu clair a pour code couleur 3*/
    bleuClair = 3,
    /** La couleur rouge foncé a pour code couleur 4*/
    rougeFonce = 4,
    /** La couleur violet a pour code couleur 5*/
    violet = 5,
    /** La couleur jaune a pour code couleur 6*/
    jaune = 6,
    /** La couleur gris a pour code couleur 7*/
    gris = 7,
    /** La couleur gris foncé a pour code couleur 8*/
    grisFonce = 8,
    ...
    rouge = 12,
    /** La couleur rose a pour code couleur 13*/
    rose = 13,
    /** La couleur jaune clair a pour code couleur 14*/
    jauneClair = 14,
