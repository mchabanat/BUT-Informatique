        ...
        <div id="top">
            ...
            <?php 
                ...
                if (!isset($_SESSION['login']) && !isset($_SESSION['pwd'])) {
                    print "<a id=\"boutonConnexion\" href=\"connexionAdmin.html\">Se connecter en Admin</a><br>";
                } else {
                    if ($_SESSION['login'] == "admin" && $_SESSION['pwd'] == "admin") {
                        print "<p id=\"erreur_numero_carte\">Pouvoir administrateur activé</p>";
                        print "<a id=\"boutonConnexion\" href=\"traitementDeconnexion.php\">Se déconnecter</a><br>";
                    }
                }
                print "</div>";
